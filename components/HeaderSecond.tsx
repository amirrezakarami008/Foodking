...
import { FaSearch, FaShoppingBasket, FaTruck, FaTwitter } from "react-icons/fa";
...
export default function HeaderSecond() {
  ...
  return (
    <section>
      <div ref={heroRef}>
        <div className="  flex border-b-[1px] border-[#21212128]  ">
        ...
        <div className=" bg-[#F4F1EA]   ">
          <div className={`  ${curentUrl == "/" ? "border-b-[1px] border-[#f4f1ea42] " : " border-none "} `}>
            <div className={`  text-[#fcfbfe] mx-auto max-w-[82rem] py-[1.2rem] items-center flex justify-between px-[1.5rem] `}>
              ...
              <div className=" flex gap-[2rem] text-[#212121] relative ">
                  ...
                  <AnimatePresence>
                    {showBox20 && (
                      <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                      >
                        <ul className={` absolute  z-[10000]  transition-opacity ease-in delay-100  shadwoCss top-[0rem] right-[-2.5rem] flex flex-col gap-[2 clrem] text-right bg-[#fff] w-[14rem] text-[#212121] `}>
