    ...
    <header>
      {curentUrl === "/" ? (
        <section className=" bg-[url('https://t-theme.com/foodking/wp-content/uploads/2024/02/hero-bg-3.jpg')]  bg-cover bg-center ">
          ...
          {curentUrl === "/" && (
            <div className=" relative pt-[4rem] text-end mx-auto max-w-[82rem]  py-[3rem] items-center flex justify-between px-[1.5rem]  ">
              <div>
                <motion.img
              ...
              <div className={`  w-[40%] ${showSticky ? "z-0" : "z-[1000000]"}  mt-[4.2rem] `}>
