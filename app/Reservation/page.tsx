        ...
        <div className="text-white bg-green-800 rounded-2xl p-6 md:p-10 w-full max-w-4xl shadow-lg">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 text-right">
            <div className="flex flex-col gap-2">
              <input
                type="text"
                placeholder="نام مشتریان"
                data-has-listeners="false"
                className="rounded-lg p-4 text-white focus:outline-none border border-gray-100 focus:ring-gray-200"
              />
            </div>
            <div className="flex flex-col gap-2">
              <select id="countries" className="border cursor-pointer border-gray-100 text-white rounded-lg focus:outline-none block w-full p-4">
                ...
                <option className="text-green-700" value="چهار نفر">یک نفر</option>
              </select>
            </div>
            <div className="flex flex-col gap-2 !justify-center">
              <div className="relative">
                ...
                <input type="text" id="input-group-1" className="p-4 border border-gray-300 text-white rounded-lg focus:outline-none block w-full" placeholder="شماره تلفن" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="relative">
                ...
                <input type="text" id="input-group-1" className="p-4 focus:outline-none !border !border-gray-100 text-white rounded-lg block w-full" placeholder="آدرس ایمیل" />
              </div>
            </div>
          </form>
