...
const AboutUs: React.FC = () => {
    ...
    return (
        <>
            <div className="w-full bg-breadcamp flex items-center justify-center py-28 mb-3">
            ...
            <div dir='rtl' className="flex flex-col gap-y-12 md:flex-row items-center justify-evenly p-6 md:p-16 bg-[#fffefb]">
                ...
                />
                    <div className="absolute top-4 right-4 text-orange-400 px-4 py-2 rounded-xl -rotate-[30deg] text-[60px] font-bold">
                        Burgur
                    </div>
                    <div className="absolute bottom-8 left-8 bg-orange-400 text-white p-5 rounded-xl rotate-[30deg] text-4xl font-bold">
                        از سال ۱۹۸۵
                    </div>
                    <div className="absolute bottom-0 right-3 text-black p-5 rounded-xl text-4xl font-bold">
                        0 تومان
                    </div>
                </div>
                {/* Text Content */}
                <div className="md:w-1/2 text-right space-y-6">
                    ...
                    <p className="text-gray-600 text-lg leading-loose">
                        این تجربه ناهار خوری عالی است که در آن هر ظرف با تازه و با کیفیت بالا درست می شود. خدمات سریع و کارآمد را تجربه کنید که تضمین می کند غذای شما تازه سرو می شود تجربه غذاخوری که در آن هر ظرف با مواد تازه و با کیفیت بالا درست می شود.
                    </p>
                    ...
                    <div className="flex gap-x-6 justify-start items-center">
                        <button className="bg-green-600 cursor-pointer text-white w-[250px] py-6 mt-4 rounded-xl shadow hover:bg-red-700">
            ...
            <div className="chef bg-amber-50 py-1">
                ...
                <div className="bg-slate-150 flex w-full h-[600px]">
                    <section
                        className=" w-1/5 h-full -space-y-60 flex-wrap flex justify-end items-center" >
